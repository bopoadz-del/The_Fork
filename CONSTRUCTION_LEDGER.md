...
| V1 | `resource_histogram` | census=REAL, first-fleet=BROKEN (conflict) | **empirical resolve (1d):** trace a real DG2 .xer | `schedule.py:546-598` | real .xer → non-zero histogram matching a hand count |
