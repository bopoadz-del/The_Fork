...
E4_VALIDATE = "Let me validate…"
E4_VALIDATE_WASTE = "Let me validate the volume against the documented waste factor."
LIVE_DANGLING = [D1, E1, HIST_TAIL, HIST_MOMENT, WIR, CHECK, E4_VALIDATE, E4_VALIDATE_WASTE]
