...
async def test_translate_block_metadata(translate_block):
    ...
    # assert "translated_text" in translate_block.config.supported_outputs  # legacy config field — n/a in current API
    # assert translate_block.config.requires_api_key == False  # legacy config field — n/a in current API
