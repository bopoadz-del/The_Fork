...
| 5 test files, 116 tests | **DONE** | `test_discipline_manifests.py` (39), `test_manifest_bindings.py` (12), `test_hat_activation.py` (22), `test_grounding_enforced.py` (30), `test_flag_off_is_noop.py` (13) -- **all passing** |
...
| `STANDARDS_SCANNER_BROADENED` | default-off | Standards scanner (NEW this session) |
