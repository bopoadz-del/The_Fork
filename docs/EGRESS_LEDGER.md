...
| E-M2 | zvec — `minishlab/potion-base-8M`, `all-MiniLM-L6-v2` (hardcoded) | `app/blocks/zvec.py:52,60` | Request (first zvec op) | Pre-seed HF cache for those exact repo ids, or disable the zvec block on-prem. |
